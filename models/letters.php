...
class muusla_toolsModelletters extends JModel
{
   ...
   function getFamilies($where) {
      $db =& JFactory::getDBO();
      $query = "SELECT familyid, familyname, address1, address2, city, statecd, zipcd FROM muusa_thisyear_family $where ORDER BY familyname, statecd, city";
      $db->setQuery($query);
