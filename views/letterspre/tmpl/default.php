...
<table class="blog" cellpadding="0" cellspacing="0">
	<tr>
		...
		<h2 class='contentheading'>Downloading Pre-Registration Confirmation Letters Data...</h2>
		</div>
		...
		<p>After downloading the Confirmation Letters Data file, click <a
			href="http://www.muusa.org/index.php?option=com_docman&task=doc_download&gid=27">here</a>
		...
		<ol>
			...
			<li>Find and pick confirmationletterpredata.csv.</li>
		...
		<ol>
			...
			confirmationletterpredata.csv.</li>
...
<script type='text/javascript' language='JavaScript'>
   setTimeout("location.href='index.php?option=com_muusla_tools&task=detail&view=letterspre';", 3000);
</script></div>
