...
<table class="blog" cellpadding="0" cellspacing="0">
	<tr>
		...
		<ol>
			...
			<li>Find and pick mailinglabeldata.csv.</li>
...
<script type='text/javascript' language='JavaScript'>
   setTimeout("location.href='index.php?option=com_muusla_tools&task=detail&view=mailinglabels';", 3000);
</script></div>
