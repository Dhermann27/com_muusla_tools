...
<table class="blog" cellpadding="0" cellspacing="0">
	<tr>
		...
		<h2 class='contentheading'>Downloading Pre-Registration Mailing Labels Data...</h2>
		</div>
		...
		<ol>
			...
			<li>Find and pick mailinglabelspredata.csv.</li>
...
<script type='text/javascript' language='JavaScript'>
   setTimeout("location.href='index.php?option=com_muusla_tools&task=detail&view=mailinglabelspre';", 3000);
</script></div>
