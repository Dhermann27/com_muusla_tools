...
<table class="blog" cellpadding="0" cellspacing="0">
	<tr>
		...
		<h2 class='contentheading'>Downloading Invoice Data...</h2>
		</div>
		<div class='article-content'><i>Please wait a moment for the download
		to begin.</i>
		<p>After downloading the Invoice Data file, click <a
			href="http://www.muusa.org/index.php?option=com_docman&task=doc_download&gid=16">here</a>
		to download the Invoice template.</p>
		...
		<ol>
			...
			<li>Find and pick invoicedata.csv.</li>
		...
		echo "               </select>\n";
		echo "               <input type='button' value='Submit' onclick=\"location.href='index.php?option=com_muusla_tools&task=detail&view=invoices&camper=' + document.getElementById('camper').options[document.getElementById('camper').selectedIndex].value;\" />\n";
		?>
...
<script type='text/javascript' language='JavaScript'>
   setTimeout("location.href='index.php?option=com_muusla_tools&task=detail&view=invoices';", 3000);
</script></div>
