...
<div id="ja-content">
<div class="componentheading">Nametags File</div>
<table class="blog" cellpadding="0" cellspacing="0">
	<tr>
		<td valign='top'>
		<div>
		<div class='contentpaneopen'>
		<h2 class='contentheading'>Downloading Nametag Data...</h2>
		</div>
		<div class='article-content'><i>Please wait a moment for the download
		to begin.</i>
		<p>After downloading the Nametag Data file, click:<br /><a
			href="http://www.muusa.org/index.php?option=com_docman&task=doc_download&gid=12">Original</a><br />
			<a
			href="http://www.muusa.org/index.php?option=com_docman&task=doc_download&gid=29">Avery 74549</a></p>
		<h3>Using Microsoft Word 2007</h3>
		<ol>
			<li>Open nametagsmerge.doc.</li>
			<li>Choose Mailings -> Select Recipients -> Use Existing List.</li>
			<li>Find and pick nametagdata.csv.</li>
		...
		echo "               </select>\n";
		echo "               <input type='button' value='Submit' onclick=\"location.href='index.php?option=com_muusla_tools&task=detail&view=nametags&camper=' + document.getElementById('camper').options[document.getElementById('camper').selectedIndex].value;\" />\n";
		?></div>
...
<script type='text/javascript' language='JavaScript'>
   setTimeout("location.href='index.php?option=com_muusla_tools&task=detail&view=nametags';", 3000);
</script></div>
