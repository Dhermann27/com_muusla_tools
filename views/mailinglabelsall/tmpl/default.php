...
<div id="ja-content">
<div class="componentheading">Mailing Labels (Last 3 Years)</div>
<table class="blog" cellpadding="0" cellspacing="0">
	<tr>
		<td valign='top'>
		<div>
		<div class='contentpaneopen'>
		<h2 class='contentheading'>Downloading Mailing Labels Data...</h2>
		</div>
		<div class='article-content'><i>Please wait a moment for the download
		to begin.</i>
		<p>After downloading the Mailing Labels Data file, click <a
			href="http://www.muusa.org/index.php?option=com_docman&task=doc_download&gid=15">here</a>
		to download the Mailng Labels template.</p>
		<h3>Using Microsoft Word 2007</h3>
		<ol>
			<li>Open mailinglabel.docx.</li>
			<li>Choose Mailings -> Select Recipients -> Use Existing List.</li>
			<li>Find and pick mailinglabelsalldata.csv.</li>
...
<script type='text/javascript' language='JavaScript'>
   setTimeout("location.href='index.php?option=com_muusla_tools&task=detail&view=mailinglabelsall';", 3000);
</script></div>
